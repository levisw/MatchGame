...
public class MatchGameTest {
    ...
    public void testPlayEasyGame2() {
        mgEasy.isMatch(2, 0, 2, 5);  //Not Match, different values
        mgEasy.isMatch(1, 4, 2, 1);  //Not Match, different values
        mgEasy.isMatch(3, 8, 2, 7);  //Not Match, different values
        mgEasy.isMatch(2, 7, 2, 10); //Not match, different values
        mgEasy.isMatch(1, 3, 3, 1);  //Not Match, different values
        assertEquals(0, mgEasy.getGuessAverage(), EPSILON, 
    ...
    public void testPlayEasyGame3() {
        mgEasy.isMatch(2, 0, 3, 0);  //Match
        mgEasy.isMatch(1, 4, 3, 4);  //Match
        mgEasy.isMatch(2, 8, 1, 8);  //Match
        mgEasy.isMatch(2, 7, 1, 7);  //Match
        mgEasy.isMatch(1, 3, 3, 3);  //Match
        assertEquals(1, mgEasy.getGuessAverage(), EPSILON, 
                     "Easy game with all correct guesses");
    }
    ...
    public void testPlayHardGame1() {
        mgHard.isMatch(1, 0, 3, 1);  //Not Match, different values or colors
        mgHard.isMatch(1, 4, 3, 2);  //Not Match, different values or colors
        mgHard.isMatch(2, 8, 1, 3);  //Not Match, different values or colors
        mgHard.isMatch(2, 7, 1, 5);  //Not Match, different values or colors
        mgHard.isMatch(1, 3, 2, 2);  //Not Match, different values or colors
        assertEquals(0, mgHard.getGuessAverage(), EPSILON, 
                     "Hard game with no correct guesses");
    }
    ...
    public void testPlayHardGame2() {
        mgHard.isMatch(2, 0, 1, 7);  //Not Match, different values or colors
        mgHard.isMatch(1, 4, 3, 4);  //Not Match, different values or colors
        mgHard.isMatch(2, 8, 1, 8);  //Match
        mgHard.isMatch(2, 7, 1, 7);  //Match
        mgHard.isMatch(0, 3, 3, 3);  //Match
        assertEquals(.6, mgHard.getGuessAverage(), EPSILON, 
                     "Hard game with some correct guesses");
    }
    ...
    public void testPlayHardGame3() {
        ...
        mgHard.isMatch(1, 4, 2, 4);  //Match
        mgHard.isMatch(2, 8, 1, 8);  //Match
        mgHard.isMatch(2, 7, 1, 7);  //Match
        mgHard.isMatch(0, 3, 3, 3);  //Match
        assertEquals(1, mgHard.getGuessAverage(), EPSILON, 
                     "Hard game with all correct guesses");
    }
